...
const translations = {
  en: {
    ...
    "about.p1": "Web Developer with a background in economics and education, I have been working in Japan for 5+ years.",
    "about.p2": "I have experience with multiple technology stacks including <b>React.js, Node.js, Typescript, Java and Python.</b> I drive digital transformation as evidenced by:",
  ...
  ja: {
    ...
    "about.p2": "<b>React.js、Node.js、Typescript、Java、Python</b>など、さまざまな技術スタックを活用した開発経験があります。以下はこれまでの実績の一例です：",
